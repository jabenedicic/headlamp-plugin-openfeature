...
Do not edit [CHANGELOG.md](./CHANGELOG.md) by hand — it is generated by
[release-please](https://github.com/googleapis/release-please) from your
Conventional Commit messages. Writing a clear `feat:`/`fix:` subject (and a
`BREAKING CHANGE:` footer where relevant) is what produces an accurate changelog
entry on the next release.
